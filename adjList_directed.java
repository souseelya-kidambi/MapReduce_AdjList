...
public class adjList_directed { 
  ...
  public static class adjMapper
	...
	if (!inline.startsWith("#"))
	{
	    ...
	    outKey.set(inVals[0]);
	    outVal.set(inVals[1]);
            System.out.println("enter map" +inVals[0] + inVals[1]);
  ...
  public static class adjReducer
    ...
    adjlst = adjlst.substring(1);
     ...
     /* if(maxcount < fincnt)
       {
          maxcount = fincnt;      
          adjlstfinal = adjlst +"#"+ maxcount;
           finalkey.set(key);
          //finalkey = key;
         // result.set(adjlstfinal);
         // context.write(maxcount,result);
       }  
       ...
       if(cntr == 0)
       {
          ...
          //finalkeymin.set(key);
          //finalkeymin = 
	finalkeymin.set(finalkeymin+","+key);
//+Text.set(",")+key;
	//Text t=new Text(finalkeymin+Text.set(",")+key);
         // result.set(adjlstfinal);
...
context.write(finalkeymin, new Text("Node with min Adj List"));
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(adjList_directed.class);
    ...
    String cmd = "sh /home/kidambsy/minmax_dir.sh";
